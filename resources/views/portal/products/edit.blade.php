        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($product, ['route' => ['products.update', $product->id], 'method'=>'PUT', 'class' => 'forms-sample border-top pt-4', 'files' => true]) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="details_fields_wrap">
                                    @foreach ($product->details as $row)
                                    <div class="row mb-2">
                                        <div class="col-sm-5">
                                            {{ Form::text('details_names[]', $row->name, [
                                        ...
                                        <div class="col-sm-5">
                                            {{ Form::text('details_values[]', $row->value, [
                                                'class' => 'form-control form-control-sm',
