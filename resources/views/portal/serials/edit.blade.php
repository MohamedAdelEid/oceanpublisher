            ...
            <div class="card">
                <div class="card-body">
                    <div class="justify-content-between d-flex mb-3">
                        <h4 class="card-title">Edit serial data</h4>
                        <a href="{{ route('serials.index') }}" class="btn btn-danger btn-rounded">
                            <i class="icon-arrow-left btn-icon-prepend"></i> Back
                        </a>
                    </div>

                    {!! Form::model($serial, ['route' => ['serials.update', $serial->id], 'method'=>'PUT', 'class' => 'forms-sample border-top pt-4']) !!}

                        <div class="form-group row">
                            <label for="code" class="col-sm-2 col-form-label required">Serial</label>
                            <div class="col-sm-8">
                                {!! Form::text('code', $serial->number, [
                                    'class' => 'form-control',
                                    "id" => "code",
                                    "readonly" => true
                                ]) !!}
